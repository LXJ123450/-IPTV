...
(function(window){	
   ...
   var NavObj = {
	   ...
	   keyHandle:function(keyCode){
		   var KEY_BACK=8,KEY_OK=13,KEY_LEFT=37,KEY_UP=38,KEY_RIGHT=39,KEY_DOWN=40,KEY_PAGEUP=33,KEY_PAGEDOWN=34,KEY_0=48,KEY_1=49,KEY_2=50,KEY_3=51,KEY_4=52,KEY_5=53,KEY_6=54,KEY_7=55,KEY_8=56,KEY_9=57,KEY_VOLUP=259,KEY_VOLDOWN=260,KEY_DEL=46,KEY_VOLUP=259,KEY_VOLDOWN=260,KEY_MUTE = 261,KEY_MPEVENT = 768,KEY_VIRTUAL = 0x0300; //del海信键值
		   switch(keyCode) {
			   case KEY_0:
			   case KEY_1:
			   case KEY_2:
			   ...
			   case 768:
				   ...
				   break;
				case KEY_VIRTUAL:
				   var ev = Utiliy.getEvent();
				   document.getElementById("echo").innerHTML += " " + "ev:" + ev;
				   if(ev.type == 'EVENT_MEDIA_END')
				   {
